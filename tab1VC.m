...
- (void)viewDidLoad {
    ...
    if(inRow == 0 && inSection == 0)
    {
        ...
        showRow.text = [NSString stringWithFormat:@"Oats, Milk, Water, Salt, and Cinnamon %lu", inRow];
    ...
    {
        outLabel.text = self.inLabelText;
        showRow.text = [NSString stringWithFormat:@"Eggs, green onions, tomato, parsley, green bell pepper, and chedar cheese %lu", inSection];
